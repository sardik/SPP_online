...
if( empty( $_SESSION['iduser'] ) ){
	...
	if( isset( $_REQUEST['aksi'] )){
		...
		?>
		<h2>Konfigurasi Tahun Pelajaran</h2><hr>
      	<div class="row">
		<div class="col-md-6">
		<table id="example" class="table table-bordered">
		<thead>
		<tr class="info"><th width="30">#</th><th width="100">Tahun Pelajaran</th>
		<th width="200"><a href="./admin.php?hlm=master&sub=tapel&aksi=baru" class="btn btn-default btn-xs">Tambah Data</a></th></tr>
		</thead>
		<tbody>
		<?php
