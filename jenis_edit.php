...
if( empty( $_SESSION['iduser'] ) ){
	...
	if( isset( $_REQUEST['submit'] )){
		...
		$sql = mysql_query("UPDATE jenis_bayar SET jumlah='$jumlah' WHERE idthajaran='$tapel' AND tingkat='$tingkat'");
		...
		$sql = mysql_query("SELECT * FROM jenis_bayar WHERE idthajaran='$tapel' AND tingkat='$tingkat'");
