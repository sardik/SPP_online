...
<div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
  <div class="container">
	<div class="navbar-header">
	  ...
	  <a class="navbar-brand" href="#"><span class="glyphicon glyphicon-dashboard"></span>SPP</a>
	</div>
	<div class="navbar-collapse collapse">
	  <ul class="nav navbar-nav">
		...
		<?php
		if( $_SESSION['admin'] != 1 ){	?>
		<li><a href="./admin.php?hlm=informasi">Informasi & Berita</a></li>
		<?php
		}
		?>
		<?php
	  ...
	  <ul class="nav navbar-nav navbar-right">
		  ...
		  <ul class="dropdown-menu">
			<li><a href="./admin.php?hlm=dashboard">Transaksi Pembayaran</a></li>
		  </ul>
		</li>
			<?php } ?>
