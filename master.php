	...
	if( isset( $_REQUEST['sub'] )){
		...
		if(isset($_REQUEST['aksi'])){
         ...
         <div class="col-md-6">
			...
			<thead>
			<tr class="info">
			<th width="30">No.</th><th>Username</th><th>Nama Lengkap</th><th width="50">Admin</th>
			<th><a href="admin.php?hlm=master&aksi=baru" class="btn btn-default btn-xs">Tambah</a></th></tr>
			</thead>
			<tbody>
			<?php
